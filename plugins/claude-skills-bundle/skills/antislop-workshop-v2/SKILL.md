...
- `copywriting-workshop` — catches patterns that slipped through direct-response copy
- `emailsequence-workshop` — clean each email in a sequence (different patterns emerge per length)
- `newsletter-workshop` — final editing pass before publishing
- `longformtweets-workshop` — tight formats show slop faster
- `landingpage-workshop` — landing pages attract buzzword buildup
